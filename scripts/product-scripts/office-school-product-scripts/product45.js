...
const product = {
  "id": 45,
  "page": "Office & School",
  "name": "Sanford Artgum Gum 2-Pack Erasers",
  "price": 4.99,
  ...
  "material": "Rubber",
  "color": "Beige",
  "description": "Remove pencil marks cleanly with the Sanford Artgum Gum 2-Pack Erasers. Designed for precise corrections, these erasers leave minimal residue and are gentle on paper."
};
